...
if exist "%~dp0start_faster_qwen3_tts.bat" (
    start "FasterQwen3TTS" cmd /k "cd /d "%~dp0" && start_faster_qwen3_tts.bat"
) else (
    echo WARNING: start_faster_qwen3_tts.bat not found - TTS will not be available
